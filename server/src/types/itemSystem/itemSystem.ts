...
export type EquipmentRegistryItem = RegistryItem & {
  slot: EquipmentSlot;
  base: EquipmentStats;
  rarity: EquipmentRarity;
  level: number;
...
export type StackableRegistryItem = RegistryItem & {
  description: string;
};

export type UnstackableRegistryItem = RegistryItem & {
  description: string;
};

export type CurrencyRegistryItem = RegistryItem & {
  description: string;
};
